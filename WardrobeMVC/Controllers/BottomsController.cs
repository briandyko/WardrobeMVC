...
namespace WardrobeMVC.Controllers
{
    public class BottomsController : Controller
    {
        ...
        {
            var bottoms = db.Bottoms.Include(b => b.Color).Include(b => b.Occasion).Include(b => b.Photo).Include(b => b.Season);
        ...
        public ActionResult Create([Bind(Include = "BottomsID,Name,PhotoID,Type,ColorID,SeasonID,OccasionID")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,Name,PhotoID,Type,ColorID,SeasonID,OccasionID")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
