...
namespace WardrobeMVC.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        {
            var accessories = db.Accessories.Include(a => a.Color).Include(a => a.Occasion).Include(a => a.Photo).Include(a => a.Season);
        ...
        public ActionResult Create([Bind(Include = "AccessoriesID,Name,PhotoID,Type,ColorID,SeasonID,OccasionID")] Accessory accessory)
        {
            ...
            ViewBag.PhotoID = new SelectList(db.Photos, "PhotoID", "Photo1", accessory.PhotoID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoriesID,Name,PhotoID,Type,ColorID,SeasonID,OccasionID")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
