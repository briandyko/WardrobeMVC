...
namespace WardrobeMVC.Controllers
{
    public class ShoesController : Controller
    {
        ...
        {
            var shoes = db.Shoes.Include(s => s.Color).Include(s => s.Occasion).Include(s => s.Photo).Include(s => s.Season);
        ...
        public ActionResult Create([Bind(Include = "ShoesID,Name,PhotoID,Type,ColorID,SeasonID,OccasionID")] Sho sho)
        {
