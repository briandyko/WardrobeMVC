...
namespace WardrobeMVC.Controllers
{
    public class TopsController : Controller
    {
        ...
        {
            var tops = db.Tops.Include(t => t.Color).Include(t => t.Occasion).Include(t => t.Photo).Include(t => t.Season);
        ...
        public ActionResult Create([Bind(Include = "TopsID,Name,PhotoID,Type,ColorID,SeasonID,OccasionID")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopsID,Name,PhotoID,Type,ColorID,SeasonID,OccasionID")] Top top)
        {
            if (ModelState.IsValid)
            {
